...
*/
        ...
        int valorVentasIngresadas = Integer.parseInt(console.readLine("Para comenzar, por favor ingresa el valor de sus ventas: "));
        if(valorVentasIngresadas>=10000){
            System.out.println("A esta venta le corresponde una comisión de "+(valorVentasIngresadas*0.3)+", por lo que deberá pagar un total de "+(valorVentasIngresadas*0.3+valorVentasIngresadas));
        } else if (valorVentasIngresadas>=5000 && valorVentasIngresadas<=9999){
            System.out.println("A esta venta le corresponde una comisión de "+(valorVentasIngresadas*0.2)+", por lo que deberá pagar un total de "+(valorVentasIngresadas*0.2+valorVentasIngresadas));
        } else if (valorVentasIngresadas>1001 && valorVentasIngresadas < 5000){
            System.out.println("A esta venta le corresponde una comisión de "+(valorVentasIngresadas*0.1)+", por lo que deberá pagar un total de "+(valorVentasIngresadas*0.2+valorVentasIngresadas));
        } else {
